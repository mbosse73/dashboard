...
<p class="unter" style="margin-top:14px"><b>Die maßgebliche Breite ist 808 px.</b>
Die Modulfläche ist in der Anwendung auf <code>860 px</code> gedeckelt
(<code>.mitte{max-width:860px}</code>, davon 52 px Rand). Ein größerer
Bildschirm ändert daran nichts — der Rest bleibt Rand. Die zweite Spalte
in der Tabelle unten zeigt deshalb nicht das Fenster, sondern die Fläche.</p>
...
<div class="mass">Gemessen <b>1011 px</b> bei 808 px Flächenbreite · gleich bei jeder Breite</div>
...
<div class="mass warn">Gemessen <b>483 px</b> bei 808 px Flächenbreite · 333 px erst ab 904 px</div>
...
viele es gibt und wie groß jede ist. <b>Dagegen — und das gibt den Ausschlag:</b> Sie braucht
<b>vier Spalten</b>, um dicht zu sein, und dafür mindestens 904 px
Flächenbreite. Die gibt es in dieser Anwendung nicht. Bei den
tatsächlichen 808 px fällt sie auf drei Spalten und 483 px. Dazu sind
die Karten unterschiedlich hoch: eine Gruppe mit einem Eintrag neben
...
<div class="mass">Gemessen <b>371 px</b> bei 808 px Flächenbreite · unverändert bis 1280 px</div>
...
sprengen. Angeheftetes trägt sein Kürzel im Chip. <b>Und sie ist die stabilste:</b> 371 px von 808 bis 1280 px
Flächenbreite, unverändert; erst unter 700 px wächst sie überhaupt.
Chips brechen um, wo Karten umbrechen müssen. <b>Dagegen:</b> Die Adresse
...
<table class="tab">
<tr><th>&nbsp;</th><th>bei 808 px<br><small>die echte Fläche</small></th><th>bei 904 px<br><small>hypothetisch</small></th><th>Gruppen sichtbar</th><th>Adresse</th><th>Aufwand</th></tr>
...
<tr><td><b>B — Gruppenkarten</b></td><td><i>483 px</i></td><td><b>333 px</b></td><td>nebeneinander</td><td>nein</td><td>mittel</td></tr>
<tr><td><b>C — Gruppenzeilen</b></td><td><b>371 px</b></td><td>371 px</td><td>als Randbeschriftung</td><td>nein</td><td>mittel</td></tr>
</table>
<div class="merk"><b>Empfehlung: C, dazu der Schnellzugriff und der
Schalter Öffnen/Ordnen.</b> Bei der Breite, die es wirklich gibt — 808 Pixel — liegt C
112 Pixel vor B, ein knappes Viertel.<br><br>
<b>Die zweite Spalte der Tabelle ist bewusst als hypothetisch
gekennzeichnet.</b> Dort wäre B die dichteste, aber diese Breite bekommt
die Modulfläche nie: <code>.mitte</code> deckelt bei 860 px, und ein
größerer Bildschirm ändert daran nichts. B braucht vier Spalten, um zu
glänzen, und bekommt drei.<br><br>
